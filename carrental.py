...
customers = [
    {'customer_id': "CU001", 'name': "Adarsh Wahewal", 'rented_cars': []},
    {'customer_id': "CU002", 'name': "Mina Lanjhewar", 'rented_cars': []},
    {'customer_id': "CU003", 'name': "Preeti Gajbe", 'rented_cars': []}
]

# Create a list to store rentals as dictionaries
rentals = []

# Function to rent a car (definition inferred from the logic shown)
...
rent_car(customers[2], cars[2]) # Corrected intended call

# Display rented cars for customers (Before Return)
...
# Display updated rented cars for customers (After Return)
